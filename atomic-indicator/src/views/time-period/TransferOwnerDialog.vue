  ...
  >
    <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
      ...
      <el-form-item label="新负责人" prop="newOwner">
        <el-select v-model="form.newOwner" placeholder="请选择" filterable style="width: 100%">
          <el-option
            v-for="u in users"
            :key="u.id"
...
const originalOwnerText = computed(() => {
  ...
  const owners = new Set(props.indicators.map((i) => i.ownerName))
